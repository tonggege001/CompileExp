...
static const yytype_uint8 yyrline[] =
{
      ...
      97,   100,   101,   107,   108,   114,   115,   116,   117,   118,
     121,   122,   125,   126,   129,   132,   133,   136,   137,   138,
     139,   140,   141,   142,   143,   146,   149,   152,   156,   157,
...
/* Line 1455 of yacc.c  */
#line 80 "parser.y"
    {(yyvsp[(1) - (1)].ptr)->parient = NULL;makeLevel((yyvsp[(1) - (1)].ptr),1);display((yyvsp[(1) - (1)].ptr),1);initTable();semanticAnalysisStatic((yyvsp[(1) - (1)].ptr),0);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 121 "parser.y"
    {(yyval.ptr) = mknode(DECLAREVALLIST,(yyvsp[(1) - (2)].ptr),(yyvsp[(2) - (2)].ptr), NULL,yylineno);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 156 "parser.y"
    {(yyval.ptr) = mknode(CONST,NULL,NULL,NULL,yylineno); (yyval.ptr)->type = T_char; (yyval.ptr)->intval = T_cst_char;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 157 "parser.y"
    {(yyval.ptr) = mknode(CONST,NULL,NULL,NULL,yylineno); (yyval.ptr)->type = T_int; (yyval.ptr)->intval = T_cst_int;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 158 "parser.y"
    {(yyval.ptr) = mknode(CONST,NULL,NULL,NULL,yylineno); (yyval.ptr)->type = T_float; (yyval.ptr)->intval = T_cst_float;;}
    break;
...
/* Line 1455 of yacc.c  */
#line 161 "parser.y"
    {(yyval.ptr) = mknode(EXP, (yyvsp[(1) - (1)].ptr),NULL,NULL,yylineno);(yyval.ptr)->op = CONST; (yyval.ptr)->type = (yyvsp[(1) - (1)].ptr)->type;;}
    break;
