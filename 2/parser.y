...
%%
Program: EXTDEFLIST {$1->parient = NULL;makeLevel($1,1);display($1,1);initTable();semanticAnalysisStatic($1,0);}
		;
...
EXP: CONST	{$$ = mknode(EXP, $1,NULL,NULL,yylineno);$$->op = CONST; $$->type = $1->type;}
