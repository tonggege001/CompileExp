...
/* Line 1455 of yacc.c  */
#line 80 "parser.y"
    {(yyvsp[(1) - (1)].ptr)->parient = NULL;makeLevel((yyvsp[(1) - (1)].ptr),1);display((yyvsp[(1) - (1)].ptr),1);initTable();semanticAnalysisStatic((yyvsp[(1) - (1)].ptr),0);TACGen((yyvsp[(1) - (1)].ptr)); PrintCode((yyvsp[(1) - (1)].ptr)->code);;}
    break;
