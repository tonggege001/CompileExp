...
// %type定义非终结符的语义值的类型
%type <ptr> Program CONST STMT DECLAREVAL DECLAREVALLIST FUNC FUNC_VAR FUNC_VAR_LIST EXTDEFLIST T_TYPE FUNC_ARG_LIST FUNC_ARG EXP BODY STMTLIST
...
FUNC_ARG_LIST:	{$$=mknode(FUNC_ARG_LIST,NULL,NULL,NULL,NULL,NULL,yylineno);}
	| EXP FUNC_ARG {$$=mknode(FUNC_ARG_LIST,$1,$2,NULL,NULL,NULL,yylineno);}
	;
...
STMT:BODY {$$=mknode(STMT,$1,NULL,NULL,NULL,NULL,yylineno);}
	...
	| T_while T_ls EXP T_rs STMT
		...
		$$=mknode(STMT,n,$3,$5,NULL,NULL,yylineno);}
	;	
