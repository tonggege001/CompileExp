...
%%
Program: EXTDEFLIST {$1->parient = NULL;makeLevel($1,1);display($1,1);initTable();semanticAnalysisStatic($1,0);ASMGen($1); PrintCode($1->code);}
		;
...
DECLAREVALLIST: DECLAREVAL DECLAREVALLIST {$$ = mknode(DECLAREVALLIST,$1,$2, NULL,yylineno);$$->arrlen = $1->arrlen;}
	| {$$=NULL;}
	;
